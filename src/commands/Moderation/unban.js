...
module.exports = { 
    ...
    async execute(interaction, client) {
        ...
        if (!interaction.member.permissions.has(PermissionsBitField.Flags.BanMembers)) return await interaction.reply({ content: "You  must have the ban member permission to use this command", ephemeral: true});
        ...
        .setColor("Blue")
        .setDescription(` :white_check_mark: <@${userID}> has benn unbanned | ${reason}`)
